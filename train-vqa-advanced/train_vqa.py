...
def train(args):
    # Dummy DataModule for running standalone (Replace with your actual DataModule import)
    ...
    # else:
    #     model = R2GenGPT(args)
    ckpt_file = "/kaggle/working/lightmedvlm/checkpoint_epoch0_step26394_rougle_l0.4304435483870967_bleu0.205962_cider0.020197.pth"
    model = LightMedVLMForTraining.load_from_checkpoint(
        ckpt_file, strict=False, args=args)
    if args.test:
