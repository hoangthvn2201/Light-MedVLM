...
parser.add_argument('--annotation_train', type=str, default='imic-subset-300k/mimic_vqa_ready_to_train_with_syn.json', help="annotation file of the dataset")
parser.add_argument('--annotation_val', type=str, default='mimic-subset-300k/mimic_vqa_ready_to_val_clean.json', help="annotation file of the dataset")
parser.add_argument('--annotation_test', type=str, default=None, help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default='mimic-subset-300k/mimic_cxr_subset_224/mimic_cxr_subset_224', help="base dir to help find images")
...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='microsoft/swin-base-patch4-window7-224', type=str, help="vision model to use  swin-base-patch4-window7-224")
parser.add_argument('--llm_model', default='Qwen/Qwen3-0.6B', type=str, help="LLM model to use")
...
parser.add_argument('--llm_r', default=8, type=int, help='The dimension used by the LoRA update matrices')
...
parser.add_argument('--vis_r', default=8, type=int, help='The dimension used by the LoRA update matrices')
...
parser.add_argument('--scorer_types', type=list, default=["ROUGE_L", "Bleu_4", "CIDEr"])

# ========================= Learning Configs ==========================
parser.add_argument('--learning_rate', default=5e-5, type=float, help='initial learning rate')
parser.add_argument('--gradient_clip_val', default=1, type=int, help='gradient clip value')
...
parser.add_argument('--max_epochs', type=int, default=25, help='Stop training once this number of epochs is reached')
